...
public class OrganizationConst {
    ...
    public static final String BRANCH_VERSION_PX = "px";        //简单培训版本
    public static final String BRANCH_VERSION_TR2 = "tr2";      //高级培训版本
    public static final String BRANCH_VERSION_KG = "kg";        //幼儿园版本
    public static final String BRANCH_VERSION_CRM = "crm";      //crm版本
}
