...
public class AttachmentManagerImpl implements AttachmentManager {
    ...
    public String getRealPath(String tempFileName, String dirName, Branch branch) {
        return tempFileName + "/home" + ApplicationContextUtil.getApplicationContext().getApplicationName() + "/WEB-INF/root/" + branch.getId() + "/" + dirName;
    }
}
